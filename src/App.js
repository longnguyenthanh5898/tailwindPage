  ...
  return (
    ...
    <>
      <div className="header-bg">
        <nav id="header" className=" w-full top-0 text-white py-1 lg:py-6">
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
            {/* logo */}
            <div className="flex items-center">
              <a href="#" className="text-white font-bold text-2xl lg:text-4xl">
                <svg
            ...
            >
              <ul className="lg:flex justify-end flex-1 items-center">
                <li className="mr-3">
                  <a
                    href="#"
                    className="inline-block text-black hover:text-gray-800 hover text-underline py-2 px-4 font-bold "
                  >
                    Active
                  </a>
                </li>
              ...
              <button
                id="navActive"
                className="font-extrabold button-bg px-8 py-4 rounded hover:underline mx-auto opacity-75 shadow"
              >
                Action
              </button>
            </div>
        ...
        <div className=" container mx-auto h-screen">
          ...
          <div class="max-w-6xl mx-auto md:mx-12 md:py-6 py-10 w-5/6 sm:w-11/12 md:w-11/12">
            <div class="w-full h-10 relative rounded-t-lg bg-white flex overflow-hidden justify-start items-center space-x-1.5 px-2">
              ...
              <span class="relative w-3 h-3 border-2 rounded-full border-yellow-800 bg-yellow-800"></span>
              <span class="relative w-3 h-3 border-2 rounded-full border-green-800 bg-green-800"></span>
            </div>
            <div class="relative bg-white border-t-0 w-full brower-mockup-h border-t">
              <div class="absolute w-full h-full inset-0 bg-white opacity-60"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:w-4/6 md:w-11/12 lg:mx-auto">
          <div className="lg:p-8 mobile:p-6 p-4 mobile:w-1/2">
            ...
            <p className="mb-4">
              ...
              cumque cupiditate explicabo atque quae similique maxime maiores ad
              tempora veniam.
            </p>
            <p>
              Images from:{" "}
      ...
      <section className="py-8 price-bg ">
        ...
        <div className="text-center">
          <button className="font-extrabold button-bg px-8 py-4 rounded mx-auto   my-6 opacity-75 shadow hover:underline">
            Action!
          </button>
        </div>
      </section>
